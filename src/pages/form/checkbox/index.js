...
export default class Index extends Taro.Component {
  ...
  constructor () {
    ...
    this.state = {
      ...
      checkboxOption4: [
        { value: 'list1', label: 'iPhone X', desc: '部分地区提供电子普通发票，用户可自行打印，效力等同纸质普通发票，具体以实际出具的发票类型为准。', arrow: 'right' },
        { value: 'list2', label: 'HUAWEI P20', thumb: 'http://img12.360buyimg.com/jdphoto/s72x72_jfs/t10660/330/203667368/1672/801735d7/59c85643N31e68303.png', arrow: 'right' },
